    ...
    <>
      ...
      <div className="flex h-screen bg-coupleBg text-coupleText">
        ...
        <div className="flex-1 p-8">
          <h1 className="text-3xl font-bold mb-4">Oda Oluştur</h1>
          <p className="mb-4">Partnerinizle etkileşime girebileceğiniz bir oda oluşturun. Oda ID’sini partnerinizle paylaşın.</p>
          
          <div className="max-w-sm bg-white p-4 rounded shadow-md">
            <label className="block mb-2 font-medium">Oda Adı:</label>
            <input
            ...
            {roomId && (
              <div className="mt-4 p-2 bg-couplePanel rounded">
                <p className="font-semibold">Oda Oluşturuldu!</p>
                <p className="text-sm">Oda ID: <span className="font-mono">{roomId}</span></p>
              </div>
            )}
          </div>
        </div>
